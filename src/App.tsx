...
const WORKSPACE_TABS: Array<{
...
}> = [
  {
    ...
    shortLabel: "Lớp học",
    description: "Quản lý học sinh, hồ sơ lớp và hoạt động chủ nhiệm theo từng lớp.",
    icon: Users
  },
  {
    id: "repository",
    label: "Kho Tài Liệu",
    shortLabel: "Tài liệu",
    description: "Lưu trữ, tra cứu và tổ chức tài liệu giảng dạy dùng chung.",
    icon: Library
  },
  {
    id: "slides",
    label: "AI Tạo Slide Bài Giảng",
    shortLabel: "Tạo slide",
    description: "Tạo bộ slide bài giảng nhanh từ nội dung môn học với hỗ trợ AI.",
    icon: Sparkles,
    iconClassName: "text-amber-500"
  },
  {
    id: "tests",
    label: "AI Tạo Đề Kiểm Tra",
    shortLabel: "Đề kiểm tra",
    description: "Sinh đề kiểm tra, câu hỏi và cấu trúc đánh giá theo mục tiêu học tập.",
    icon: ClipboardCheck,
  ...
  },
  {
    ...
    shortLabel: "Bài cũ",
    description: "Chuẩn bị hoạt động hỏi đáp, trò chơi và tương tác ôn bài trên lớp.",
    icon: Award,
  ...
  },
  {
    id: "journal",
    label: "Sổ Đầu Bài AI",
    shortLabel: "Sổ đầu bài",
    description: "Ghi nhận nhật ký lớp học, nhận xét và tổng hợp diễn biến từng buổi học.",
    icon: FileText,
...
export default function App() {
  ...
  const activeWorkspace = WORKSPACE_TABS.find((tab) => tab.id === activeTab) ?? WORKSPACE_TABS[0];
